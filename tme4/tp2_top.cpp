...
int _main (int argc, char *argv[])
{
    ...
    size_t  icache_sets     	= 16;                   // instruction cache number of sets
    size_t  icache_words    	= 8;              	// instruction cache number of words per line
    size_t  dcache_ways     	= 4;              	// data cache number of ways
    size_t  dcache_sets     	= 256;             	// data cache number of sets
    size_t  dcache_words    	= 16;              	// data cache number of words per line
