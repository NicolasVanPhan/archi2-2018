...
ctx_loop_done:
	...
	# This mut be consistent with the icu_mask_array[] below...
        lw      $26,    _interrupt_vector       # interrupt vector address
...
pid_stop:	
	lw	$27,	_tty_write		# $27 <= adresse _tty_write
        ori	$4,     $0,     0       	# $4 <= 0 (tty_index = 0)
        lw      $5,     pid_message		# $5 <= message address
...
task_id_stop:	
	lw	$27,	_tty_write		# $27 <= adresse _tty_write
        ori	$4,     $0,     0       	# $4 <= 0 pid
        lw      $5,     task_id_message		# $5 <= message address
        jalr	$27              		# print message
        ori     $6,     $0,	48             	# $6 <= message length
task_id_dead:	
...
icu_masks_array:		# mask for the IRQ routing : indexed by pid
	...
	.word	0b00001111000000000100010000000001	# ICU_MASK[2]
	.word	0b11110000000000001000100000000001	# ICU_MASK[3]
